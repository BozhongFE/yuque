          ...
          k.addMultiple({
              ...
              each: function(a, b) {
                  ...
                  var l = "@value"
                    , m = "@key"
                    , n = "@index";
                  b.params ? (l = b.params[0] && b.params[0].name,
                  m = b.params[1] && b.params[1].name,
                  n = b.params[2] && b.params[2].name,
                  b = b.rules) : b = b.ruleset;
                  for (var o = 0; o < g.length; o++) {
                      var p, q, r = g[o];
                      r instanceof f ? (p = "string" == typeof r.name ? r.name : r.name[0].value,
                      q = r.value) : (p = new e(o + 1),
                      q = r),
                      r instanceof d || (c = b.rules.slice(0),
                      ...
                      k.push(new h([new i([new j("","&")])],c,b.strictImports,b.visibilityInfo())))
                  }
                  ...
                  function l(c, e) {
                      ...
                      if (a(c, h))
                          ...
                          if (o && Buffer.isBuffer(c))
                              return p = Buffer.allocUnsafe ? Buffer.allocUnsafe(c.length) : new Buffer(c.length),
                              c.copy(p),
                              p;
                          a(c, Error) ? p = Object.create(c) : "undefined" == typeof f ? (q = Object.getPrototypeOf(c),
                          p = Object.create(q)) : (p = Object.create(f),
                          q = f)
                      }
                      if (d) {
                          var r = m.indexOf(c);
                      ...
                      if (Object.getOwnPropertySymbols)
                          for (var u = Object.getOwnPropertySymbols(c), s = 0; s < u.length; s++) {
                              ...
                              (!w || w.enumerable || i) && (p[v] = l(c[v], e - 1),
                              w.enumerable || Object.defineProperty(p, v, {
                                  enumerable: !1
                              }))
                          }
                      if (i)
